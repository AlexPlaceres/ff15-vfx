...
public struct Color : IFlatbufferObject
{
  ...
  public static Offset<ReblackVfx.FlatBuffer.Math.Color> CreateColor(FlatBufferBuilder builder, float R, float G, float B, float A) {
    builder.Prep(4, 16);
    builder.PutFloat(A);
    builder.PutFloat(B);
    builder.PutFloat(G);
    builder.PutFloat(R);
    return new Offset<ReblackVfx.FlatBuffer.Math.Color>(builder.Offset);
  }
}
