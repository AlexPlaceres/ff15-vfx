...
public struct UbyteArrayTable : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_25_12_19(); }
  public static UbyteArrayTable GetRootAsUbyteArrayTable(ByteBuffer _bb) { return GetRootAsUbyteArrayTable(_bb, new UbyteArrayTable()); }
  public static UbyteArrayTable GetRootAsUbyteArrayTable(ByteBuffer _bb, UbyteArrayTable obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public UbyteArrayTable __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<ReblackVfx.FlatBuffer.BaseType.UbyteArrayTable> CreateUbyteArrayTable(FlatBufferBuilder builder,
      VectorOffset dataOffset = default(VectorOffset)) {
    builder.StartTable(1);
    UbyteArrayTable.AddData(builder, dataOffset);
    return UbyteArrayTable.EndUbyteArrayTable(builder);
  }

  public static void StartUbyteArrayTable(FlatBufferBuilder builder) { builder.StartTable(1); }
  ...
  public static Offset<ReblackVfx.FlatBuffer.BaseType.UbyteArrayTable> EndUbyteArrayTable(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<ReblackVfx.FlatBuffer.BaseType.UbyteArrayTable>(o);
  }
}


static public class UbyteArrayTableVerify
{
